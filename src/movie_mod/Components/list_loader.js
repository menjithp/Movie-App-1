...
export default () => (
  <div className="my-2 pt-1 grid-display main-item">
    {Array.from(Array(20)).map((x, i) => (
      <div  key={i} className="movie-card-animate-container">
...
export const list_loader= Array.from(Array(20)).map((x, i) => (
  <div  key={i+Math.random()} className="movie-card-animate-container">
    <div className="animated-background">
      <div className="background-masker"></div>
    </div>
    <div className="p-2">
